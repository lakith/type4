...
public class CreditCardPaymentBreakDown {
    ...
    public CreditCardPaymentBreakDown(String comment, int valueOf5000Notes, int valueOf2000Notes, int valueof1000Notes, int valueOf500Notes, int valueOf100Notes, int valueOf50Notes, int valueOf20Notes, int valueOf10Notes, double valueOfcoins, double amount, CrediitCardPeyment crediitCardPeyment) {
    ...
    public int getCreditCardPaymentBreakDownId() {
        return creditCardPaymentBreakDownId;
    }

    public void setCreditCardPaymentBreakDownId(int creditCardPaymentBreakDownId) {
        this.creditCardPaymentBreakDownId = creditCardPaymentBreakDownId;
    }
