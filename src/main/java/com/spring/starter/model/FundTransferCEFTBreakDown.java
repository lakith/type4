...
public class FundTransferCEFTBreakDown {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private int fundTransferCEFTBreakDownId;
    ...
    public FundTransferCEFTBreakDown(String comment, int valueOf5000Notes, int valueOf2000Notes, int valueof1000Notes, int valueOf500Notes, int valueOf100Notes, int valueOf50Notes, int valueOf20Notes, int valueOf10Notes, double valueOfcoins, double amount, FundTransferCEFT fundTransferCEFT) {
    ...
    public int getFundTransferCEFTBreakDownId() {
        return fundTransferCEFTBreakDownId;
    }

    public void setFundTransferCEFTBreakDownId(int fundTransferCEFTBreakDownId) {
        this.fundTransferCEFTBreakDownId = fundTransferCEFTBreakDownId;
    }
    ...
    public FundTransferCEFT getFundTransferCEFT() {
        return fundTransferCEFT;
    }
