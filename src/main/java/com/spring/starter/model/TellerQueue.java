...
public class TellerQueue {
    ...
    public TellerQueue(TransactionCustomer transactionCustomer, String queueNumber, boolean complete,
                       String comment, boolean hold, boolean queueReject, boolean queuePending, Date queueStartDate,
                       Date queueEndDate, double queueNumIdentification) {
